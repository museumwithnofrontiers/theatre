...
The **Museum With No Frontiers — Theatre** gallery, built from the published
dataset `@museumwnf/theatre-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/theatre-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/theatre/> through the reusable workflows in
