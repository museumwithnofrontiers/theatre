...
// `useGalleryData.js` used to be byte-identical local copies of what theatre
...
// legacy project key, no UUID — theatre shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (theatre-data 1.0.11+), an outside
