...
export default {
  ...
  siteName: manifest.site?.names?.en ?? 'theatre',
  ...
  home: {
    title: 'theatre.identity.title',
    intro: 'theatre.home.intro',
    cards: [
      {
        title: 'theatre.nav.catalogue',
        description: 'theatre.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'theatre.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'theatre.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'theatre.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'theatre.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'theatre.partnerObjects.emptyPartner',
  //         emptyInstitution: 'theatre.partnerObjects.emptyInstitution',
  //         institutionSummary: 'theatre.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'theatre.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'theatre.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
